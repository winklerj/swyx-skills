...
- [smart-entity-resolution](./smart-entity-resolution) — resolve named people or organizations in messy databases with aliases, duplicates, sparse records, common names, LLM reranking, and visible runner-up candidates.
